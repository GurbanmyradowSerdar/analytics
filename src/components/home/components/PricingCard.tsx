...
const PricingCard = ({ amountOfUsers, name, price }: IPricesCard) => {
  return (
    <div className="flex flex-col bg-[#11214E] px-14 py-12 rounded-3xl gap-12 flex-[0_1_25%] group hover:bg-white transition-all duration-300 hover:scale-105 shadow-xl">
      ...
      <div className="flex flex-col text-center justify-center items-center gap-1">
        <p className="text-3xl text-white font-bold flex items-end transition-colors duration-300 group-hover:text-text-main-color">
          $
          <MainTitle
            text={price.toString()}
